...
<body>
                ...
                <section class="flex items-center justify-between gap-5">
                    <div>
                        ...
                        <p class="text-lg min-[350px]:text-2xl font-bold text-white" id="checkout-grand-total-price">
                            Rp 3.290.000 <!-- Ini bisa di-update dengan JavaScript jika perlu -->
                        </p>
                    </div>
                    <button type="submit"
    ...
    {{-- perhitungan data checkout --}}
    <script>
        function calculatePrice() {
            let subTotal = 0;
            let deliveryFee = 1000;

            // Menghitung subtotal dari harga produk
